<template>
  <div class="min-h-[600px] flex flex-col">
    ...
    <div class="flex-1 overflow-y-auto p-6">
      ...
      <!-- Empty State with Upload Option (Engineer) -->
...
const loadAttachments = async () => {
  ...
  try {
    console.log('🔥 DEBUG: Loading attachments for engineer ticket:', fullTicketId.value)
...
const onFilesSelected = (files) => {
  ...
  console.log('🔥 DEBUG: Files selected for engineer upload:', files.length)
}

const onUploadSuccess = (response) => {
  console.log('✅ DEBUG: Engineer upload successful:', response)
  selectedFiles.value = []
...
const onUploadError = (errorMessage) => {
  console.error('❌ DEBUG: Engineer upload failed:', errorMessage)
  error.value = errorMessage
}

// File type utilities (same as manager side)
